...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "-7ZhFnPnLimTvgkYMRup7kb-n99SFtqQH82bWHuP";
    private static final String SECRETKEY = "0obPB61J69kKEx_42jhrXvFlokN1oAZjFh_gNrwK";
    private static final String BUCKET = "heimasz74";
    public static final String DOMAIN = "pyd8lwep2.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("E:\\aa\\gao2.jpg","gao2.jpg");
